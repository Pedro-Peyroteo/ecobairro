...
| --- | -------- | ---------------------------- | -------------------------------------------------------------------------- | ------------------------ | ----------------------------------------------------------- |
| E6  | `POST`   | `/ecopontos`                 | Criar ecoponto                                                             | GESTOR, ADMIN | NestJS → PG write → NOTIFY → Redis invalidar zona           |
| E7  | `PUT`    | `/ecopontos/:id`             | Actualizar dados (nome, tipologias, acessibilidade, horário)               | GESTOR, ADMIN | NestJS → PG write → NOTIFY → del `ecoponto:{id}` + zona     |
